...
var APP_ID = 'nwONHFixNzhW7gbICe23THSa-gzGzoHsz';
var APP_KEY = 'zRMfYvL7QJwKf7K9xR84L0u9';
...
var app = new _vue2.default({
  ...
  methods: {
    fetchTodos: function fetchTodos() {
      ...
      if (this.currentUser) {
        ...
        query.find().then(function (todos) {
          var avAllTodos = todos[todos.length - 1];
    ...
    removeTodo: function removeTodo(todo) {
      // todo 就是点击的那一个事项
      var index = this.todoList.indexOf(todo); // 点击的那一个事项在数组中的索引
